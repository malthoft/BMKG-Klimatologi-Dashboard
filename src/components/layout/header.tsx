    ...
    <>
      ...
      >
        <div className="flex justify-between items-center w-full px-[32px] py-[16px] max-w-7xl mx-auto">
          <Link href="/" className="flex items-center gap-3 md:gap-4 cursor-pointer hover:opacity-90 transition-opacity shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 160 199" className="h-11 md:h-14 w-auto shrink-0">
