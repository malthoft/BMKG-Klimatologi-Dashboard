        ...
        <div className="bg-white/80 backdrop-blur-xl border-b border-slate-100">
          <div className="flex justify-between items-center w-full px-4 md:px-8 py-2 md:py-3 max-w-7xl mx-auto">
            ...
            <Link href="/" className="flex items-center gap-3 md:gap-4 cursor-pointer hover:opacity-90 transition-opacity shrink-0 group">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 160 199" className="h-11 md:h-14 w-auto shrink-0 drop-shadow-xs">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex md:hidden items-baseline gap-1">
                <span className="font-mono text-slate-800 font-extrabold text-[11px] uppercase tracking-wide leading-tight">
                  {wibTime.hh}<span className={colonClass}>:</span>{wibTime.mm}
                </span>
                <span className="text-sky-600 font-extrabold text-[10px] uppercase tracking-wide leading-tight">WIB</span>
              </div>
