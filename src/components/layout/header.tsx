    ...
    <>
      ...
      >
        <div className="flex justify-between items-center w-full px-[32px] py-[16px] max-w-7xl mx-auto">
          <Link href="/" className="font-bold text-black flex items-center gap-[10px] cursor-pointer text-[1.5rem] hover:opacity-90 transition-opacity">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 160 199" className="h-9 w-auto">
            ...
            <span>Stasiun Klimatologi Jawa Timur</span>
          </Link>
